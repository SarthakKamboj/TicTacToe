...
void draw_filled_circle(const filled_circle_t& circle) {
	int vao_idx = globals.filled_circle_data.vao_idx;
	int shader_idx = globals.filled_circle_data.shader_idx;
	int ebo_idx = globals.filled_circle_data.ebo_idx;
